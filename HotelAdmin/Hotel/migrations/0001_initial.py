# Generated by Django 5.1 on 2024-12-09 19:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_habitacion', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Precio')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Fecha de Última Actualización')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_reserva', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('CONFIRMADA', 'Confirmada'), ('CANCELADA', 'Cancelada'), ('CHECK-OUT', 'Check-Out')], default='PENDIENTE', max_length=20, verbose_name='Estado de Reserva')),
                ...
                ('habitaciones', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Hotel.habitacion', verbose_name='Habitaciones')),
